...
<br>
## If this workshop resonates with your energy, sign-up here:
...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:1px; border-width:1px; border-color:#C0CCD9; border-style:solid; direction:ltr">
      <form id="sib-form" method="POST" action="https://7e3feee7.sibforms.com/serve/MUIFAGl5wPYX-2lX2iKdR6pF8T2eSVLWBu4AIOM8QjKO1mHSg53_N0RlpLsN-948HNP1AvB7_esOrX8ekM1qikhBwj55etz6Ujg4y6IWRM0D_uW6L7VhcMl3GFLcp3M3R14ikzr8PzKCgGR-FNLkS6ZvcnnnqvPoaONxUNayy-YQJtKEonzpgeQ8O6uq1-jp1LGQn0tJ5cWWUGJg" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-select sib-form-block" data-required="true">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <div class="entry__field">
                  <select class="input" id="EVENTDATE" name="EVENTDATE" data-required="true">
